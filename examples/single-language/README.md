# next-md-blog Single Language Example

This is a single-language example Next.js application demonstrating how to use the `next-md-blog` library with one language.
...
The example uses **Tailwind CSS v4** with **OKLCH colors** and the **@tailwindcss/typography** plugin for styling. You can customize:
...
The example uses OKLCH color format (Tailwind CSS v4's default) for better color consistency:
...
The example includes a theme toggle component that cycles through:
