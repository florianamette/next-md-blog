      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
            next-md-blog Multi-Language Example
          </h1>
          <p className="text-xl text-muted-foreground mb-8">
            A Next.js example application demonstrating multi-language support with next-md-blog
          </p>
          <div className="flex gap-4 justify-center">
            ...
            <Button variant="outline" asChild>
              <Link href="/en/blog/welcome">Example Post (EN)</Link>
            </Button>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
                ...
                <li>
                  Initialize:{' '}
                  <code className="bg-muted px-2 py-1 rounded text-sm">npx @florianamette/next-md-blog-init --i18n-enabled</code>
                </li>
                <li>
