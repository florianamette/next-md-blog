 ...
 * Users can use this in their next-mdx-blog.config.ts file
 * 
 * @example
 * ```ts
 * import { createConfig } from 'next-mdx-blog';
 * 
 ...
 * 
 * Note: In Next.js, import your `next-mdx-blog.config.ts` file directly and pass it to functions.
